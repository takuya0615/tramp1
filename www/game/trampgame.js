...
//gamecenter Fetch Player Image仮
var successCallback1 = function (path) {
    alert(path); // path to .jpg
};

//gamecenter submitscore仮
gamecenter.getPlayerImage(successCallback1, failureCallback1);

var data1 = {
    score: sls,
    leaderboardId: "board1"
};
gamecenter.submitScore(successCallback, failureCallback, data1);
*/
...
/*ボタンアクション(全てのボタンにbtnpushedをするだけのontouchstartイベントを付加する)
その後用意してあるそれぞれのtouchendイベントでpushedを消す
※できてない*/
...
//phasemenu
    ...
    challenge.addEventListener('touchend', function() {
        challengestage.className = "";
        btnpull.apply(this);

        ch_st1.addEventListener('touchend', function() {
              challengemode();
              initlevel = 2;
          });
        ...
        if (sll > 6) {
          ...
          ch_st5.addEventListener('touchend', function() {
                challengemode();
                initphasemenu();
                initlevel = 6;
            });
    ...
    challenge.addEventListener('touchstart', function() {
              btnpushed.apply(this);
      });


    timelimit.addEventListener('touchend', function() {
        timelimitstage.className = "";
        btnpull.apply(this);

        ti_st1.addEventListener('touchend', function() {
              timelimitmode();
              initlevel = 26;
          });
        ...
        if (stl > 6) {
          ...
          ti_st5.addEventListener('touchend', function() {
                timelimitmode();
                initphasemenu();
                initlevel = 6;
            });
    ...
    timelimit.addEventListener('touchstart', function() {
            btnpushed.apply(this);
    });
    ...
    */
    ...
    rtn1.addEventListener('touchend', function() {
        btnpull.apply(this);
        initphasemenu();
    });

    rtn1.addEventListener('touchstart', function() {
        btnpushed.apply(this);
    });
...
//phasegame1
    ...
    rtn2.addEventListener('touchend', function() {
        phasegame1.className = "invisible";
        phasemenu.className = "";
        timeflg = false;
    });

    rtn2.addEventListener('touchstart', function() {
    });
...
//phasegame2
    ...
    var rtn3,
          ...
          rtn3.addEventListener('touchend', function() {
              phasegame2.className = "invisible";
              phasemenu.className = "";
              timeflg = false;
          });

          rtn3.addEventListener('touchstart', function() {
          });
...
//phaseclear    ※tramp()内。levelがtramp()内のローカル変数のため。
            ...
            nextstage.addEventListener('touchend', function() {
                btnpull.apply(this);
            ...
            nextstage.addEventListener('touchstart', function() {
                btnpushed.apply(this);
            });

            rtn5.addEventListener('touchend', function() {
                phaseclear.className = "invisible";
                phasemenu.className = "";
                timeflg = false;
            });
...
//phasegameover    ※tramp()内。levelがtramp()内のローカル変数のため。
            ...
            rtn4.addEventListener('touchend', function() {
            ...
            rtn4.addEventListener('touchstart', function() {
            });

             retry.addEventListener('touchend', function() { //retry時の処理
               btnpull.apply(this);
            ...
            fromstart.addEventListener('touchend', function() {
                btnpull.apply(this);
            ...
            fromstart.addEventListener('touchstart', function() {
                btnpushed.apply(this);
            });
            ...
            topmenu.addEventListener('touchstart', function() {
                btnpushed.apply(this);
            });
...
//phaseoption もちろんtramp()外
            var rtn6,
             ...
             gamecentershow = document.getElementById('timescore');
             ...
             rtn6.addEventListener('touchend', function() { //retry時の処理
            　btnpull.apply(this);
              ...
              rtn6.addEventListener('touchstart', function() {
                btnpushed.apply(this);
              });


/*
            gamecentershow.addEventListener('touchend', function() { //gamecenterのリーダーボードを見る仮
            　btnpull.apply(this);
               var data = {
                leaderboardId: "board1"
                };
              ...
              gamecentershow.addEventListener('touchstart', function() {
                btnpushed.apply(this);
              });

*/
            　showdelete.addEventListener('touchend', function() {
            　   btnpull.apply(this);
        ...
        //記録の削除
             deletelifegame.addEventListener('touchend', function() { //retry時の処理
             ...
             deletetimegame.addEventListener('touchend', function() { //retry時の処理
                if (confirm("Challengeの記録を削除してもいいですか？")) {
            ...
            deleteall.addEventListener('touchend', function() { //retry時の処理
                if (confirm("Challengeの記録を削除してもいいですか？")) {
                localStorage.removeItem('sts');
                localStorage.removeItem('stl');
                sts = null;
